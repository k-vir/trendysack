...
<head>
    ...
    <title>Rotate JPG files, online</title>
</head>
        ...
        <div class="grid">
            ...
            <div class="content">
                ...
                <div class="tool_drag_area">
                    <div class="tool_head">
                        <h1 class="tool_name">Rotate JPG</h1>
                        <h2 class="naration"> Please select JPEG/JPG file to Rotate.</h2>
                        <p></p>
                    </div>
                    <div class="choose_files_area">
                        ...
                        <div  class="select_files">
                            ...
                            <label class="convert_btn" for="upload_btn" hidden>Rotate</label>
                        </div>  
                    </div>
                </div>
                <div class="tool_option_sidebar">
                    <div class="options">
                        ...
                        <h2>Tool Settings</h2>
                        <p>Uploaded JPG file will get Rotated.</p>
                        <!-- <div>
