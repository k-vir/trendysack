...
<head>
    ...
    <script>
        $(function () {
            ...
            $("#ads").load("../templates/sidebarads.php");
        });
    </script>
    
    <title>Convert PDF to JPEG, online</title>
</head>
        ...
        <div class="grid">
            ...
            <div class="content">
                ...
                <div class="tool_drag_area">
                    <div class="tool_head">
                        <h1 class="tool_name">PDF to JPEG</h1>
                        <h2 class="naration"> Please select PDF file to convert.</h2>
                        <p></p>
                    </div>
                    <div class="choose_files_area">
                        ...
                        <div  class="select_files">
                            <form id="select_form" class="form">
                                <input id="browse" class="browse" type="file" accept=".pdf" onchange="image_select()"  multiple hidden>
                            ...
                            <input type="submit" name="upload_button" class="upload_btn" onclick="upload_files()" id="upload_btn" value="Upload" hidden/>
                            <label class="browse_btn" for="browse">Select PDF file</label>
                            <label class="convert_btn" for="upload_btn" hidden>Convert</label>
                        </div>  
                    </div>
                </div>
                <div class="tool_option_sidebar">
                    <div class="options">
                        ...
                        <h2>Tool Settings</h2>
                        <p>Uploaded PDF file will be converted to JPEG.</p>
                    </div>
                </div>
            </div>
