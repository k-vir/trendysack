...
session_unset();
session_start();
$_SESSION["tool_used"] = 'compressjpg';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Compress JPG files, online</title>
</head>
        ...
        <div class="grid">
            ...
            <div class="content">
                ...
                <div class="tool_drag_area">
                    <div class="tool_head">
                        <h1 class="tool_name">Compress JPG</h1>
                        <h2 class="naration"> Please select JPEG/JPG file to Compress.</h2>
                        <p></p>
                    </div>
                    <div class="choose_files_area">
                        ...
                        <div  class="select_files">
                            ...
                            <label class="convert_btn" for="upload_btn" hidden>Compress</label>
                        </div>  
                    </div>
                </div>
                <div class="tool_option_sidebar">
                    <div class="options">
                        ...
                        <h2>Tool Settings</h2>
                        <p>Uploaded JPG file will get compressed.</p>
                        <!-- <div>
                            <h3>Set Compression Level</h3>
                            <div id="compression_lvl" class="compression_lvl">
                                <input type="radio" id="cmp_lvl" class="10" value="1.11" name="cmp_lvl">
                                <label for="10">10%</label>
                                <input type="radio" id="cmp_lvl" class="20" value="1.25" name="cmp_lvl">
                                <label for="20">20%</label>
                                <input type="radio" id="cmp_lvl" class="30" value="1.43" name="cmp_lvl" checked>
                                <label for="30">30%</label>
                                <input type="radio" id="cmp_lvl" class="40" value="1.67" name="cmp_lvl">
                                <label for="40">40%</label>
                                <input type="radio" id="cmp_lvl" class="50" value="2" name="cmp_lvl">
